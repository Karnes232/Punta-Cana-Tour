export const InvoiceBody = (name) => {
  ...
  <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
      <p style="line-height: 140%;">Our team has scheduled your tours, and the pickup times are confirmed. Please find all the details below. If you have any questions or need further assistance, we're here to help!</p>
    </div>
