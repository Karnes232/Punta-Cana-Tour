export const InvoiceTour = (tour, pickup, date, guests) => {
  ...
  <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    <tbody>
      <tr>
        ...
        <img 
        src='https:${tour?.mainImage?.file?.url}'
        alt="Logo" width="80" height="80" class='tourImage'>
        <div class='innerDivTourCard' style='padding:0px 0px 0px 10px;'>
          <h1 class='tourName'>${tour.name}</h1>
          <div class='tourPriceDiv' style='justify-content: space-between;!important'>
          <p style='color: rgb(75 85 99)'>$${
            tour?.price
          }</p><p class='paddingLeft' style='color: rgb(75 85 99); padding:0px 0px 0px 10px;'>${guests} pax</p>
      <p class='paddingLeft' style='color: rgb(31 41 55); padding:0px 0px 0px 10px;'>$${
        tour?.price * guests
      }</p>
