...
const Index = ({ data }) => {
  return (
    ...
    >
      <HeroComponent
        gImage={data.allContentfulBlogLayout.nodes[0].tourBlogImage.gatsbyImage}
        heroText="Tour Blogs"
        button={false}
      />
      <TextComponent
        ...
        paragraph={
          data.allContentfulBlogLayout.nodes[0].tourBlogDescription
            .tourBlogDescription
        }
...
export const Head = ({ data }) => {
  const { title, description } = categoryBySlug("tours");
  return (
    <>
      <Seo title={title} description={description} />
      <link rel="canonical" href="https://puntacanatourstore.com/blog/tours/" />
    </>
  );
};
