...
import { TravelAgentTour } from "../components/Email/TravelAgentTour";
...
export default function handler(req, res) {
  ...
  const htmlString = `${Head}${Css}${HtmlHeader}${Body(clientName)}${
    tourList[0] ? TravelAgentTour(tourList[0], PickUp1, Date1) : ""
  }${tourList[1] ? TravelAgentTour(tourList[1], PickUp2, Date2) : ""}${
    tourList[2] ? TravelAgentTour(tourList[2], PickUp3, Date3) : ""
  }${
    tourList[3] ? TravelAgentTour(tourList[3], PickUp4, Date4) : ""
